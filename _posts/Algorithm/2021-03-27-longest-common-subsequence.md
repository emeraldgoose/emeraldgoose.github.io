...
![](https://drive.google.com/uc?export=view&id=1xgheEaXJq1YSY1r4G7fhyl_mabu64BwR)

배열의 첫 번째 행과 열은 모두 0으로 채워준다. 다음 행인 'C'에 대해 LCS를 구하면 다음 그림과 같다.

![](https://drive.google.com/uc?export=view&id=1yktKtvTsuc5_PnQoEnExFekFrRC11Y_9)

문자열 'ACAYKP'는 'C'이후로 공통된 문자열이 하나이므로 1을 채워준다. 다음 A에 대해 채워주면 다음과 같다.

![](https://drive.google.com/uc?export=view&id=1jmY-h48FbMzv1qB9s6nXm1e_ASMVSR_y)

2번째 행을 채울 때 (1,2)가 1이고 두 문자열의 'A'가 같으므로 (1, 2)의 값 + 1인 값이 (2, 3)에 저장된다.

![](https://drive.google.com/uc?export=view&id=1qte5z8UL3MRNlHUdRt1pgj68hhHxCTFJ)
...
![](https://drive.google.com/uc?export=view&id=1-jchdMr0YI42az3MWC4Hu_B_AMDfzx0q)

여기서 LCS의 길이가 아닌 문자열을 찾고 싶다면 큰 숫자가 시작되는 위치를 찾으면 된다.

![](https://drive.google.com/uc?export=view&id=1XzvdLXfkXl5sPTNh5ZCGR1k3YqQm9bUJ)
